...
import { useUserType, UserType } from '../app/context/UserTypeContext';
import { User, Utensils, Truck } from 'lucide-react-native';

interface UserTypeSwitcherProps {
  compact?: boolean;
}

export default function UserTypeSwitcher({ compact = false }: UserTypeSwitcherProps) {
