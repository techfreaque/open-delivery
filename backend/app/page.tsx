    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8">
            Welcome to the OpenEats Partner Portal. Sign up or login to manage your restaurant, track your deliveries,
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="border rounded-lg p-6 shadow-sm">
              ...
              <p className="mb-6">Manage your menu, track orders, and update your restaurant profile.</p>
            ...
            <div className="border rounded-lg p-6 shadow-sm">
              ...
              <p className="mb-6">Track your deliveries, manage your availability, and view your earnings.</p>
            ...
            <div className="border rounded-lg p-6 shadow-sm">
              ...
              <p className="mb-6">Manage users, view platform statistics, and configure global settings.</p>
      ...
      <footer className="bg-muted py-6">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} OpenEats. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
