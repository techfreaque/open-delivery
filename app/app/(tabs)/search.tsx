...
import { View, Text, StyleSheet, TextInput, FlatList, Image, TouchableOpacity, useWindowDimensions } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { Search, Star, Clock, X } from 'lucide-react-native';
      ...
      <View style={[styles.contentContainer, isLargeScreen && styles.largeScreenContentContainer]}>
        ...
        {searchQuery ? (
          ...
          <View style={styles.popularContainer}>
            <Text style={[styles.popularTitle, isLargeScreen && styles.largeScreenSectionTitle]}>
              Popular Cuisines
            </Text>
            <View style={[styles.popularGrid, isLargeScreen && styles.largeScreenPopularGrid]}>
              {['Pizza', 'Burgers', 'Sushi', 'Mexican', 'Chinese', 'Indian'].map((cuisine, index) => (
                <TouchableOpacity 
                  key={index} 
                  style={[styles.popularItem, isLargeScreen && styles.largeScreenPopularItem]}
                  onPress={() => setSearchQuery(cuisine)}
                >
                  <Text style={[styles.popularItemText, isLargeScreen && styles.largeScreenText]}>
                    {cuisine}
                  </Text>
                </TouchableOpacity>
              ))}
