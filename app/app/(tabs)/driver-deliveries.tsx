...
import { MapPin, Clock, Phone, MessageSquare, Navigation, CircleCheck as CheckCircle, X } from 'lucide-react-native';
...
export default function DriverDeliveriesScreen() {
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            ...
            Alert.alert("Success", "Delivery accepted! Head to the restaurant to pick up the order.");
          }
        }
      ]
    );
  ...
  const handleMessageCustomer = (name) => {
    Alert.alert(
      "Message Customer",
      `Would you like to message ${name}?`,
      [
        {
          text: "Cancel",
          style: "cancel"
    ...
    <SafeAreaView style={styles.container}>
          ...
          {activeTab === 'active' ? (
            ...
            activeDeliveries.length > 0 ? (
                ...
                <View key={delivery.id} style={styles.deliveryCard}>
                  <View style={styles.deliveryHeader}>
                    <View style={styles.restaurantInfo}>
                      ...
                      <View>
                        ...
                        <Text style={styles.orderTime}>Order time: {delivery.orderTime}</Text>
                      </View>
                    </View>
                    <View style={[
                      styles.statusBadge, 
                  ...
                  <View style={styles.deliveryInfo}>
                    <View style={styles.infoItem}>
                      ...
                      <Text style={styles.infoText}>{delivery.customer.address}</Text>
                    </View>
                    <View style={styles.infoItem}>
                      <Clock size={16} color="#6B7280" />
                      <Text style={styles.infoText}>ETA: {delivery.estimatedDelivery}</Text>
                    </View>
                    <View style={styles.infoItem}>
                    ...
                    <View style={styles.infoItem}>
                      ...
                      <Text style={styles.infoText}>{formatCurrency(delivery.total)}</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.deliveryActions}>
                    <TouchableOpacity 
                      ...
                      onPress={() => Alert.alert("Navigation", "Opening navigation to customer's address...")}
                    >
              ...
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptyText}>You don't have any active deliveries at the moment.</Text>
                <TouchableOpacity 
                  style={styles.emptyButton}
                  onPress={() => setActiveTab('available')}
                >
                  <Text style={styles.emptyButtonText}>Find Available Deliveries</Text>
                </TouchableOpacity>
              </View>
            )
          ) : (
            ...
            availableDeliveries.length > 0 ? (
                ...
                <View key={delivery.id} style={styles.availableDeliveryCard}>
                  <View style={styles.availableDeliveryHeader}>
                    ...
                    <View style={styles.availableDeliveryInfo}>
                      <Text style={styles.availableRestaurantName}>{delivery.restaurant.name}</Text>
                      <View style={styles.availableDeliveryMeta}>
                        <View style={styles.availableDeliveryMetaItem}>
                          <MapPin size={14} color="#6B7280" />
                          <Text style={styles.availableDeliveryMetaText}>{delivery.distance}</Text>
                        </View>
                        <View style={styles.availableDeliveryMetaItem}>
                          <Clock size={14} color="#6B7280" />
                          <Text style={styles.availableDeliveryMetaText}>{delivery.estimatedTime}</Text>
                        </View>
                      </View>
                    </View>
                    <Text style={styles.availableDeliveryTotal}>{formatCurrency(delivery.total)}</Text>
                  </View>
                  
                  <View style={styles.availableDeliveryDetails}>
                    <View style={styles.availableDeliveryDetail}>
                      <Text style={styles.availableDeliveryDetailLabel}>Pickup:</Text>
                      <Text style={styles.availableDeliveryDetailValue}>{delivery.restaurant.address}</Text>
                    </View>
                    <View style={styles.availableDeliveryDetail}>
                      <Text style={styles.availableDeliveryDetailLabel}>Dropoff:</Text>
                      <Text style={styles.availableDeliveryDetailValue}>{delivery.customer.address}</Text>
                    </View>
                  </View>
              ...
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptyText}>There are no available deliveries in your area at the moment.</Text>
                <TouchableOpacity 
                  style={styles.emptyButton}
                  onPress={() => setActiveTab('active')}
                >
                  <Text style={styles.emptyButtonText}>Check Active Deliveries</Text>
                </TouchableOpacity>
              </View>
            )
          )}
      ...
      {selectedDelivery && deliveryDetailsVisible && (
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContainer, isLargeScreen && styles.largeScreenModalContainer]}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Delivery Details</Text>
              <TouchableOpacity onPress={() => setDeliveryDetailsVisible(false)}>
            ...
            <ScrollView style={styles.modalContent}>
              ...
              <View style={styles.modalSection}>
                ...
                <View style={styles.modalRestaurantInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.modalRestaurantName}>{selectedDelivery.restaurant.name}</Text>
                    <Text style={styles.modalRestaurantAddress}>{selectedDelivery.restaurant.address}</Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.modalSection}>
                ...
                <Text style={styles.modalCustomerName}>{selectedDelivery.customer.name}</Text>
                <Text style={styles.modalCustomerAddress}>{selectedDelivery.customer.address}</Text>
                <View style={styles.modalCustomerActions}>
                  <TouchableOpacity 
                    style={styles.modalCustomerAction}
                    onPress={() => handleCallCustomer(selectedDelivery.customer.phone)}
                  >
                  ...
                  <TouchableOpacity 
                    style={styles.modalCustomerAction}
                    onPress={() => handleMessageCustomer(selectedDelivery.customer.name)}
                  >
              ...
              <View style={styles.modalSection}>
                ...
                <View style={styles.modalOrderTotal}>
                  ...
                  <Text style={styles.modalOrderTotalValue}>{formatCurrency(selectedDelivery.total)}</Text>
                </View>
              </View>
              ...
              <View style={styles.modalSection}>
                ...
                <View style={styles.modalDeliveryInfo}>
                  <View style={styles.modalDeliveryInfoItem}>
                    ...
                    <Text style={styles.modalDeliveryInfoValue}>{selectedDelivery.distance}</Text>
                  </View>
                  <View style={styles.modalDeliveryInfoItem}>
                    <Text style={styles.modalDeliveryInfoLabel}>Estimated Time:</Text>
                    <Text style={styles.modalDeliveryInfoValue}>{selectedDelivery.estimatedDelivery}</Text>
                  </View>
                  <View style={styles.modalDeliveryInfoItem}>
                    <Text style={styles.modalDeliveryInfoLabel}>Order Time:</Text>
                    <Text style={styles.modalDeliveryInfoValue}>{selectedDelivery.orderTime}</Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.modalActions}>
                ...
                {selectedDelivery.status === 'picked up' && (
                  <TouchableOpacity 
                    ...
                    onPress={() => handleUpdateStatus(selectedDelivery, 'delivered')}
                  >
                    <CheckCircle size={20} color="#FFFFFF" />
                    <Text style={styles.modalCompleteButtonText}>Mark as Delivered</Text>
                  </TouchableOpacity>
                )}
                ...
                {selectedDelivery.status === 'assigned' && (
                  <TouchableOpacity 
                    ...
                    onPress={() => handleUpdateStatus(selectedDelivery, 'picked up')}
                  >
                    <CheckCircle size={20} color="#FFFFFF" />
                    <Text style={styles.modalPickupButtonText}>Mark as Picked Up</Text>
                  </TouchableOpacity>
                )}
              </View>
            </ScrollView>
