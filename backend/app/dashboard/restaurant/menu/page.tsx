...
export default function RestaurantMenu() {
  ...
  const handleToggleAvailability = (id: string) => {
    ...
    toast({
      title: item?.isAvailable ? "Item marked as unavailable" : "Item marked as available",
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button className="mt-4 md:mt-0" onClick={() => setEditingItem(null)}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                {editingItem ? "Update the details of your menu item." : "Fill in the details to add a new menu item."}
              </DialogDescription>
            </DialogHeader>
            <form onSubmit={handleAddItem}>
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Select name="category" defaultValue={editingItem?.category || "Main"}>
                    <SelectTrigger>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Switch id="isAvailable" name="isAvailable" defaultChecked={editingItem?.isAvailable ?? true} />
                </div>
              </div>
              <DialogFooter>
          ...
          <Card key={item.id} className={!item.isAvailable ? "opacity-60" : ""}>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => handleToggleAvailability(item.id)}>
                      <Switch className="mr-2" checked={item.isAvailable} onCheckedChange={() => {}} />
            ...
            <CardContent>
              ...
              <div className="flex items-center justify-between">
                ...
                {!item.isAvailable && (
                  <span className="text-xs bg-muted px-2 py-1 rounded-md">Currently Unavailable</span>
                )}
              </div>
            </CardContent>
          </Card>
