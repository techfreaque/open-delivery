...
import { View, Text, StyleSheet, TouchableOpacity, Image, useWindowDimensions, TextInput } from 'react-native';
import { useRouter } from 'expo-router';
import { Search, ShoppingBag, User, LogOut, Menu, X, Utensils, Truck } from 'lucide-react-native';
...
export default function DesktopHeader({ currentAddress, onAddressChange, cartItemCount = 0 }: DesktopHeaderProps) {
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.headerContent, isLargeScreen && styles.largeScreenContent]}>
              ...
              {userType === 'customer' && (
                <>
                  <View style={styles.mobileAddressSelector}>
                    <Text style={styles.mobileMenuSectionTitle}>Delivery Address</Text>
                    <AddressSelector
                      onSelectAddress={onAddressChange}
                      currentAddress={currentAddress}
                      showLabel={false}
