...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Image, useWindowDimensions, TextInput, Modal } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { Search, Filter, Clock, MapPin, Phone, MessageSquare, X, Check, AlertCircle } from 'lucide-react-native';
      ...
      <ScrollView>
        <View style={[styles.contentContainer, isLargeScreen && styles.largeScreenContentContainer]}>
          ...
          <View style={styles.header}>
            <Text style={[styles.headerTitle, isLargeScreen && styles.largeScreenHeaderTitle]}>
              Manage Orders
            </Text>
          ...
          <View style={styles.searchFilterContainer}>
            ...
            <View style={styles.filterContainer}>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                {['all', 'new', 'preparing', 'ready', 'out for delivery', 'delivered', 'cancelled'].map((status) => (
                  <TouchableOpacity
                    key={status}
                    style={[
                      styles.filterButton,
                      filterStatus === status && styles.activeFilterButton,
                      filterStatus === status && { backgroundColor: getStatusColor(status) + '20' }
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        ...
                        filterStatus === status && { color: getStatusColor(status) }
                      ]}
                    >
            ...
            <View style={[styles.modalContent, isLargeScreen && styles.largeScreenModalContent]}>
              ...
              <View style={styles.orderDetailSection}>
                <View style={styles.orderDetailHeader}>
                  <View>
                    <Text style={styles.orderDetailId}>Order #{selectedOrder.id}</Text>
                    <Text style={styles.orderDetailTime}>{selectedOrder.time}</Text>
                    <View style={[
              ...
              <View style={styles.orderDetailSection}>
                <Text style={styles.orderDetailSectionTitle}>Customer Information</Text>
                <View style={styles.customerInfo}>
                  ...
                  <View style={styles.customerContact}>
                    <View style={styles.customerContactItem}>
                      ...
                      <Text style={styles.customerContactText}>{selectedOrder.customerPhone}</Text>
                    </View>
                    <View style={styles.customerContactActions}>
                      ...
                      <TouchableOpacity 
                        style={styles.contactButton}
                        onPress={() => handleMessageCustomer(selectedOrder.customerName)}
                      >
              ...
              <View style={styles.orderDetailSection}>
                ...
                <View style={styles.deliveryAddressContainer}>
                  ...
                  <Text style={styles.deliveryAddressText}>{selectedOrder.customerAddress}</Text>
                </View>
              </View>
              ...
              <View style={styles.orderDetailSection}>
                ...
                {selectedOrder.items.map((item, index) => (
                  <View key={index} style={styles.orderDetailItem}>
                    ...
                    <Text style={styles.orderDetailItemPrice}>{formatCurrency(item.price * item.quantity)}</Text>
                  </View>
                ))}
                <View style={styles.orderDetailTotal}>
                  <Text style={styles.orderDetailTotalLabel}>Total</Text>
                  <Text style={styles.orderDetailTotalValue}>{formatCurrency(selectedOrder.total)}</Text>
                </View>
              </View>

              <View style={styles.orderDetailSection}>
                <Text style={styles.orderDetailSectionTitle}>Payment Information</Text>
                <View style={styles.paymentInfo}>
                  <Text style={styles.paymentMethod}>
                    Payment Method: {selectedOrder.paymentMethod === 'card' ? 'Credit Card' : 'Cash on Delivery'}
                  </Text>
                  <Text style={styles.paymentStatus}>
                    Payment Status: {selectedOrder.paymentMethod === 'card' ? 'Paid' : 'To be collected'}
                  </Text>
                </View>
              </View>
        ...
        {selectedOrder && (
          <View style={styles.modalContainer}>
            <View style={[styles.modalContent, isLargeScreen && styles.largeScreenModalContent]}>
              ...
              <Text style={styles.updateStatusSubtext}>Select a new status for this order:</Text>
