        ...
        <View style={[styles.contentContainer, isLargeScreen && styles.largeScreenContentContainer]}>
          ...
          <View style={styles.restaurantHeader}>
            ...
            <View style={styles.restaurantInfo}>
              ...
              <Text style={styles.welcomeText}>Welcome back! Here's your restaurant overview.</Text>
            </View>
          </View>
          ...
          <View style={[styles.statsContainer, isLargeScreen && styles.largeScreenStatsContainer]}>
            <View style={[styles.statCard, isLargeScreen && styles.largeScreenStatCard]}>
              ...
              <Text style={styles.statValue}>{restaurantData.stats.ordersToday}</Text>
            ...
            <View style={[styles.statCard, isLargeScreen && styles.largeScreenStatCard]}>
              ...
              <Text style={styles.statValue}>${restaurantData.stats.revenue}</Text>
            ...
            <View style={[styles.statCard, isLargeScreen && styles.largeScreenStatCard]}>
              ...
              <Text style={styles.statValue}>{restaurantData.stats.averageRating}</Text>
            ...
            <View style={[styles.statCard, isLargeScreen && styles.largeScreenStatCard]}>
              ...
              <Text style={styles.statValue}>{restaurantData.stats.activeOrders}</Text>
              ...
              <View key={order.id} style={styles.orderCard}>
                ...
                <View style={styles.orderFooter}>
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => router.push(`/restaurant-orders?id=${order.id}`)}
                  >
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={isLargeScreen && styles.popularItemsGrid}>
              {restaurantData.popularItems.map((item) => (
                <View key={item.id} style={[styles.popularItemCard, isLargeScreen && styles.largeScreenPopularItemCard]}>
                  ...
                  <View style={styles.popularItemInfo}>
                    ...
                    <View style={styles.popularItemStats}>
                      <View style={styles.popularItemStat}>
                        ...
                        <Text style={styles.popularItemStatText}>{item.orderCount} orders</Text>
                      </View>
                      <View style={styles.popularItemStat}>
                        <User size={16} color="#F59E0B" />
                        <Text style={styles.popularItemStatText}>{item.rating}</Text>
                      </View>
                    </View>
                  </View>
                </View>
          ...
          <View style={styles.quickActionsContainer}>
            ...
            >
              <ShoppingBag size={24} color="#EF4444" />
              <Text style={[styles.quickActionText, { color: '#EF4444' }]}>Manage Orders</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={[styles.quickActionText, { color: '#0EA5E9' }]}>Update Menu</Text>
            </TouchableOpacity>
