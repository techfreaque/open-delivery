...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Image, useWindowDimensions, Modal } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { MapPin, Clock, DollarSign, Calendar, ChevronRight, X, Star } from 'lucide-react-native';
      ...
      <ScrollView>
        <View style={[styles.contentContainer, isLargeScreen && styles.largeScreenContentContainer]}>
          ...
          <View style={styles.earningsSummary}>
            ...
            <View style={[styles.earningsCards, isLargeScreen && styles.largeScreenEarningsCards]}>
              <View style={[styles.earningCard, isLargeScreen && styles.largeScreenEarningCard]}>
                <View style={[styles.earningIconContainer, { backgroundColor: '#FEE2E2' }]}>
                  <DollarSign size={24} color="#EF4444" />
                </View>
                <Text style={styles.earningAmount}>{formatCurrency(earningsData.today)}</Text>
                <Text style={styles.earningPeriod}>Today</Text>
              </View>
              
              <View style={[styles.earningCard, isLargeScreen && styles.largeScreenEarningCard]}>
                <View style={[styles.earningIconContainer, { backgroundColor: '#E0F2FE' }]}>
                  <DollarSign size={24} color="#0EA5E9" />
                </View>
                <Text style={styles.earningAmount}>{formatCurrency(earningsData.week)}</Text>
                <Text style={styles.earningPeriod}>This Week</Text>
              </View>
              
              <View style={[styles.earningCard, isLargeScreen && styles.largeScreenEarningCard]}>
                <View style={[styles.earningIconContainer, { backgroundColor: '#DCFCE7' }]}>
                  <DollarSign size={24} color="#10B981" />
                </View>
                <Text style={styles.earningAmount}>{formatCurrency(earningsData.month)}</Text>
            ...
            <View key={day.id} style={styles.dayContainer}>
              <View style={styles.dayHeader}>
                ...
                <Text style={styles.deliveryCount}>
                  {day.deliveries.length} {day.deliveries.length === 1 ? 'delivery' : 'deliveries'}
                </Text>
              </View>
                ...
                >
                  <View style={styles.deliveryHeader}>
                    ...
                    <View style={styles.deliveryAmount}>
                      <Text style={styles.deliveryTotal}>{formatCurrency(delivery.total)}</Text>
                      <Text style={styles.deliveryTip}>+{formatCurrency(delivery.tip)} tip</Text>
                    </View>
                  </View>
              ...
              <ScrollView style={styles.modalContent}>
                ...
                <View style={styles.modalSection}>
                  ...
                  <View style={styles.modalDetailItem}>
                    ...
                    <Text style={styles.modalDetailValue}>{selectedDelivery.time}</Text>
                  </View>
                  <View style={styles.modalDetailItem}>
                    <Text style={styles.modalDetailLabel}>Distance:</Text>
                    <Text style={styles.modalDetailValue}>{selectedDelivery.distance}</Text>
                  </View>
                </View>
                ...
                <View style={styles.modalSection}>
                  ...
                  <View style={styles.modalDetailItem}>
                    ...
                    <Text style={styles.modalDetailValue}>{formatCurrency(selectedDelivery.total - selectedDelivery.tip)}</Text>
                  </View>
                  <View style={styles.modalDetailItem}>
                    <Text style={styles.modalDetailLabel}>Tip:</Text>
                    <Text style={styles.modalDetailValue}>{formatCurrency(selectedDelivery.tip)}</Text>
                  </View>
                  <View style={[styles.modalDetailItem, styles.modalTotalItem]}>
                    <Text style={styles.modalTotalLabel}>Total Earnings:</Text>
                    <Text style={styles.modalTotalValue}>{formatCurrency(selectedDelivery.total)}</Text>
                  </View>
                </View>
