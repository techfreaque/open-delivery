  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          "overflow-auto",
          scrollViewVariants({ direction: actualDirection, padding, className }),
          {
            "overflow-x-auto": actualDirection === "horizontal",
            "overflow-y-auto": actualDirection !== "horizontal",
            "scrollbar-hide": 
              (actualDirection === "horizontal" && !showsHorizontalScrollIndicator) || 
              (actualDirection !== "horizontal" && !showsVerticalScrollIndicator),
          },
        )}
        style={style}
        {...props}
