...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Image, TextInput, Modal, useWindowDimensions, Alert } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { Search, Plus, CreditCard as Edit2, Trash2, X, DollarSign, Camera, Save } from 'lucide-react-native';
...
const initialMenuItems = [
  {
    ...
    description: 'Two beef patties with cheddar cheese, lettuce, tomato, onion, and special sauce.',
    price: 8.99,
...
export default function RestaurantMenuScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.editFormContainer}>
                  ...
                  {categories.filter(cat => cat !== 'All').map((category) => (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        editedItem.category === category && styles.selectedCategoryPickerButton
                      ]}
                      onPress={() => setEditedItem({...editedItem, category})}
                    >
                      <Text
                        style={[
                          styles.categoryPickerButtonText,
                          editedItem.category === category && styles.selectedCategoryPickerButtonText
                        ]}
                      >
                        {category}
                      </Text>
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => setEditedItem({...editedItem, image: text})}
                  placeholder="Enter image URL"
                />
                <View style={styles.imagePreviewContainer}>
                  {editedItem.image ? (
                    <Image source={{ uri: editedItem.image }} style={styles.imagePreview} />
                  ) : (
              ...
              <View style={styles.formGroup}>
                ...
                <View style={styles.availabilityContainer}>
                  <TouchableOpacity
                    ...
                    onPress={() => setEditedItem({...editedItem, available: true})}
                  >
                    <Text
                      style={[
                        styles.availabilityOptionText,
                        editedItem.available && styles.selectedAvailabilityOptionText
                      ]}
                    >
                      Available
                    </Text>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => setEditedItem({...editedItem, available: false})}
                  >
                    <Text
                      style={[
                        styles.availabilityOptionText,
      ...
      >
        <View style={styles.modalContainer}>
          <View style={[styles.modalContent, styles.deleteModalContent, isLargeScreen && styles.largeScreenDeleteModalContent]}>
            <View style={styles.modalHeader}>
