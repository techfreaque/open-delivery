...
import { View, Text, StyleSheet, Image, TouchableOpacity, ScrollView, Switch, Alert, TextInput, Modal } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { ChevronRight, LogOut, CreditCard, Bell, MapPin, CircleHelp as HelpCircle, Settings, Heart, Gift, Edit2 } from 'lucide-react-native';
...
export default function ProfileScreen() {
  ...
  const handleAddAddress = () => {
    ...
    setAddresses([...addresses, { id: newId, address: newAddress, default: false }]);
    setNewAddress('');
  ...
  const handleAddPaymentMethod = () => {
    ...
    setPaymentMethods([...paymentMethods, { id: newId, type: 'Card', last4, default: false }]);
    setNewCardNumber('');
    setNewCardExpiry('');
    setNewCardCVV('');
